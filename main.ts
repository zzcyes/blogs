...
const docsList = getDocsList(path.resolve(__dirname, "docs")).sort(
  (a: IFDocsItem, b: IFDocsItem) => -a.createTimeMs + b.createTimeMs
);
...
fs.writeFileSync(
  ...
  readmeStr.substring(0, readmeStr.indexOf("## 目录") + 5) + "\n\r" + readmeMd
);
