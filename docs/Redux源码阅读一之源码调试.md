...
![redux-debugger-image-20220523143711304](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220523143711304.png)
...
![redux-debugger-image-20220523144704410](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220523144704410.png)

打开  `rollup.config.js` 文件，可以看到不同版本的构建信息

![redux-debugger-image-20220523145036749](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220523145036749.png)
...
![redux-debugger-image-20220524110458367](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524110458367.png)
...
![redux-debugger-image-20220524111908683](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524111908683.png)

为了验证 `npm link` 是否成功，我们先通过 `npm config get prefix` 命令查看 `prefix` 值，在这里是`C:\Users\admin\AppData\Roaming\npm` 

![redux-debugger-image-20220524110936982](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524110936982.png)

再进入到 `{prefix}/lib/node_modules/<package>` 目录下看 `redux` 是否被链接到全局。

![redux-debugger-image-20220524112032408](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524112032408.png)
...
![redux-debugger-image-20220524112142220](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524112142220.png)
...
![redux-debugger-image-20220524113638619](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524113638619.png)
...
![redux-debugger-image-20220524145050748](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524145050748.png)
...
![redux-debugger-image-20220524145654269](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524145654269.png)

在 react 项目中通过 createStore 函数创建 store ，然后在组件中使用 store（省略详细代码，重点不是如何使用 redux）

![redux-debugger-image-20220524150948764](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524150948764.png)

通过 `yarn start` 运行项目后，会发现 console 输出了我们在 redux 项目中 debugger 打印的信息。

![redux-debugger-image-20220524151255113](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524151255113.png)

可以看到 Sources 面板中，展示了我们打断点的源码信息，需要注意的是，我们是在 `redux.js` 文件中进行的断点调试，那为什么这里显示的是`createStore.ts` 文件的信息呢? 

![redux-debugger-image-20220524151322772](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524151322772.png)

### Source Map

还记得之前我们修改过 `rollup.config.js` 文件的配置吗，我们配置了  `sourcemap: true`。在 rollup 打包的时候，会在原有输出目录下多打包出一个  `*.js.map` 的文件

![redux-debugger-image-20220524151953295](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524151953295.png)
...
![redux-debugger-image-20220524152831314](https://gitee.com/zzcyes/repository/raw/master/images/redux-debugger-20220524152831314.png)
